...
public class FXMLLoginController implements Initializable {
    ...
    public void adminLogin(ActionEvent event) {
        try {
            ...
            if (inputEmail.getText().isEmpty() || inputPassword.getText().isEmpty()) {
                ...
                UserData loadedUser = (UserData)  xstream.fromXML(new java.io.File("users.xml"));
                ...
                if (inputEmail.getText().equals(loadedUser.getEmail()) && inputPassword.getText().equals(loadedUser.getPassword())) {
                    ...
                    openScene.openScene("FXMLHomePage", buttonSignUp);
                } else {
    ...
    public void register(ActionEvent event) {
        openScene.openScene("FXMLRegister", buttonSignUp);
    }
